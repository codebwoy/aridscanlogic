...
export const APP_GUIDE_MODULES = [
  ...
  },
  {
    ...
    featuresDe: [
      ...
      'BizStart Germany — Businessplan, Lebenslauf-Builder, GewA-1-Formular, Krankenkasse & Website-Rechtliches',
    ...
    featuresEn: [
      ...
      'BizStart Germany — business plan, tabular CV builder, GewA 1 form, Krankenkasse & website legal pages',
