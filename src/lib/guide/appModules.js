...
export const APP_GUIDE_MODULES = [
  ...
  },
  {
    ...
    featuresDe: [
      ...
      'Master-Pfad Vermögensaufbau DE + Zielrechner/Allokations-Szenarien + ETF-/Sparplan-/Smart-Money-/Finanztip-/Kinder-/Trading-Bildung',
    ...
    featuresEn: [
      ...
      'Master wealth-building path for Germany + goal lab/allocation scenarios + ETF/savings-plan/smart-money/Finanztip/kids/trading education',
    ...
    workflowDe: [
      ...
      'Optional: Finanz-Bildung — Zielrechner & Szenarien, dann „Vermögensaufbau Deutschland“ und Spezialkurse (keine Anlageberatung).',
    ...
    workflowEn: [
      ...
      'Optional: Finance education — goal lab & scenarios, then “Building wealth in Germany” and specialty courses (not investment advice).',
