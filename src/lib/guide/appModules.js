...
export const APP_GUIDE_MODULES = [
  ...
  },
  {
    ...
    summaryDe:
      'Tax Vault bündelt betriebliche Ausgaben für die Steuererklärung: gescannte Belege, manuelle Einträge, Kilometer, Kategorien und Schätzungen (Gewerbesteuer, ESt, USt).',
    summaryEn:
      'Tax Vault collects business expenses for tax prep: scanned receipts, manual entries, mileage, categories, and estimates (trade tax, income tax, VAT).',
    featuresDe: [
    ...
    workflowDe: [
      'Profil unter Tax Vault Settings anlegen (Firma, Kleinunternehmer …).',
      'Belege scannen oder manuell erfassen.',
      'Kategorie prüfen, ggf. Kilometer buchen.',
      'Berichte und Export für den Steuerberater nutzen.',
    ],
    workflowEn: [
      'Set up profile in Tax Vault Settings (business, small-business rule …).',
      'Scan or enter receipts.',
      'Confirm category; log mileage if needed.',
      'Use reports/exports for your tax advisor.',
    ],
  ...
  },
  {
    ...
    featuresDe: [
      '6+ Vorlagen (NDA, Freelance, Employment …)',
    ...
    featuresEn: [
      '6+ templates (NDA, freelance, employment …)',
