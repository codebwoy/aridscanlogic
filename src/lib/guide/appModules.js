...
export const APP_GUIDE_MODULES = [
  ...
  },
  {
    ...
    featuresDe: [
      ...
      'BizStart Germany — Businessplan, Lebenslauf- & Anschreiben-Builder (DIN 5008), GewA-1-Formular, Krankenkasse & Website-Rechtliches',
    ...
    featuresEn: [
      ...
      'BizStart Germany — business plan, tabular CV & DIN 5008 cover letter builders, GewA 1 form, Krankenkasse & website legal pages',
