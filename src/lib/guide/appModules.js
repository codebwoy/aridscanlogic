...
export const APP_GUIDE_MODULES = [
  ...
  },
  {
    ...
    featuresDe: [
      ...
      'BizStart Germany — Businessplan, Lebenslauf- & Anschreiben-Builder (DIN 5008), TailorCV Stellen-Zuschnitt, GewA-1-Formular, Krankenkasse & Website-Rechtliches',
      'ETF-, Sparplan-, Smart-Money-, Finanztip-, Kindersparen- & Trading-Risiko-Bildung — Prinzipien, Kostenlogik, VV vs DIY',
    ...
    featuresEn: [
      ...
      'BizStart Germany — business plan, tabular CV & DIN 5008 cover letter builders, TailorCV job tailoring, GewA 1 form, Krankenkasse & website legal pages',
      'ETF, savings-plan, smart-money, Finanztip, kids-savings & trading-risk education — principles, cost logic, managed vs DIY',
    ...
    workflowDe: [
      ...
      'Optional: Finanz-Bildung (ETFs, Sparplan, Smart Money, Finanztip, Kindersparen, Trading-Risiken) — keine Anlage-/VV-Empfehlung.',
    ...
    workflowEn: [
      ...
      'Optional: Finance education (ETFs, savings plans, smart money, Finanztip, kids savings, trading risks) — not investment/wealth-manager advice.',
      'Use Tax Overhead hub for health, trade tax, and VAT estimates.',
      'Scan receipts, confirm categories, export for your tax advisor.',
    ],
    connectsDe: [
      'Docs (Scan → Beleg)',
      'Settings → Tax Vault Settings',
      'Finanzfluss ETF-Handbuch (extern)',
      'Finanztip Bücher (extern)',
      'ETF4Kids Kindersparen (extern)',
      'Freedom24 ETF-Investment-Plan (extern)',
      'LIQID Smart Money Leitfaden (extern)',
      'WH SelfInvest Scalper-E-Book (extern)',
    ],
    connectsEn: [
      'Docs (scan → receipt)',
      'Settings → Tax Vault Settings',
      'Finanzfluss ETF handbook (external)',
      'Finanztip books (external)',
      'ETF4Kids kids savings (external)',
      'Freedom24 ETF investment plan (external)',
      'LIQID Smart Money guide (external)',
      'WH SelfInvest Scalper ebook (external)',
    ],
    tipsDe: [
      'Kleinunternehmer-Status beeinflusst MwSt-Anzeige.',
      'Regelmäßig Backup mit Passphrase erstellen.',
      'Finanz-Lektionen sind Bildung — keine Kauf-, Broker-, VV- oder Handelsempfehlungen.',
    ],
    tipsEn: [
      'Small-business status affects VAT display.',
      'Create encrypted backups regularly.',
      'Finance lessons are educational — not buy, broker, wealth-manager, or trade recommendations.',
    ],
  },
  {
    id: 'docdraft',
