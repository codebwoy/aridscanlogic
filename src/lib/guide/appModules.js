...
export const APP_GUIDE_MODULES = [
  ...
  },
  {
    ...
    featuresDe: [
      ...
      'Master-Pfad Vermögensaufbau DE + ETF-/Sparplan-/Smart-Money-/Finanztip-/Kinder-/Trading-Bildung',
    ...
    featuresEn: [
      ...
      'Master wealth-building path for Germany + ETF/savings-plan/smart-money/Finanztip/kids/trading education',
    ...
    workflowDe: [
      ...
      'Optional: Finanz-Bildung — zuerst „Vermögensaufbau Deutschland“, dann Spezialkurse (keine Anlageberatung).',
    ...
    workflowEn: [
      ...
      'Optional: Finance education — start with “Building wealth in Germany”, then specialty courses (not investment advice).',
    ...
    connectsDe: [
      ...
      'Finanztip / Verbraucherzentrale / Stiftung Warentest (extern)',
      'Finanzfluss ETF-Handbuch (extern)',
      'ETF4Kids, Freedom24 LP, LIQID Leitfaden, WH SelfInvest (extern)',
    ],
    connectsEn: [
      'Docs (scan → receipt)',
      'Settings → Tax Vault Settings',
      'Finanztip / Verbraucherzentrale / Stiftung Warentest (external)',
