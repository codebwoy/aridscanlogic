...
const STRINGS = {
  de: {
    ...
    total: 'Betrag EUR',
    net: 'Nettobetrag',
    gross: 'Rechnungssumme Gesamt',
    grossInclVat: 'Rechnungssumme inkl. MwSt.',
    ...
    pricesIncludeVat: 'Preise inkl. MwSt. (Brutto)',
    articleNo: 'Art.-Nr.',
  ...
  en: {
    ...
    expiryDate: 'Expiry',
    articleNo: 'Art.-Nr.',
    pricesIncludeVat: 'Prices incl. VAT (gross)',
...
export function formatMoney(amount, currency = 'EUR', lang = 'de') {
  ...
  try {
    ...
    const formatted = n.toFixed(2).replace('.', lang === 'en' ? '.' : ',')
